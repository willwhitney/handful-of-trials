...
class VisibleHalfCheetahConfigModule:
    ENV_NAME = "VisibleHalfCheetah-v2"
    TASK_HORIZON = 1000
    NTRAIN_ITERS = 100000
    ...
    def __init__(self):
        experiment_name = "paper-xvel_taskhorizon{}_trainiters{}_rolloutsperiter{}_planhor_{}".format(
...
CONFIG_MODULE = VisibleHalfCheetahConfigModule
